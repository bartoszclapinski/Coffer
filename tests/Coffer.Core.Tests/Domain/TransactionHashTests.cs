...
{
    private const string _account = "PL61109010140000071219812874";

    [Fact]
    public void Compute_SameInputs_ProducesSameHash()
    {
        var date = new DateOnly(2025, 11, 28);
        var hashA = TransactionHash.Compute(_account, date, -49.99m, "BIEDRONKA 1234");
        var hashB = TransactionHash.Compute(_account, date, -49.99m, "BIEDRONKA 1234");
    ...
    {
        var hashA = TransactionHash.Compute(_account, new DateOnly(2025, 11, 28), -49.99m, "BIEDRONKA 1234");
        var hashB = TransactionHash.Compute(_account, new DateOnly(2025, 11, 27), -49.99m, "BIEDRONKA 1234");
    ...
    public void Compute_DifferentAmount_ChangesHash()
    {
        var date = new DateOnly(2025, 11, 28);
        var hashA = TransactionHash.Compute(_account, date, -49.99m, "BIEDRONKA 1234");
        var hashB = TransactionHash.Compute(_account, date, -50.00m, "BIEDRONKA 1234");
    ...
    public void Compute_DifferentDescription_ChangesHash()
    {
        var date = new DateOnly(2025, 11, 28);
        var hashA = TransactionHash.Compute(_account, date, -49.99m, "BIEDRONKA 1234");
        var hashB = TransactionHash.Compute(_account, date, -49.99m, "BIEDRONKA 5678");
    ...
    {
        var hash = TransactionHash.Compute(_account, new DateOnly(2025, 11, 28), -49.99m, "X");
    ...
    public void Compute_AmountFormattedInvariant_NoCultureLeakage()
    {
        ...
        var date = new DateOnly(2025, 11, 28);
        var hashA = TransactionHash.Compute(_account, date, 1234.5m, "X");
        var hashB = TransactionHash.Compute(_account, date, 1234.50m, "X");
